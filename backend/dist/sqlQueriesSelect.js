...
exports.fetchAndBuildExams = exports.fetchAnswerOptions = exports.fetchQuestions = exports.fetchExams = void 0;
...
function fetchAndBuildExams() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const exams = yield fetchExams();
            if (exams) {
...
exports.fetchAndBuildExams = fetchAndBuildExams;
